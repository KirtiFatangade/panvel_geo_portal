  ...
  return (
    <div className="policy-container">
      ...
      <p>
        ...
        regulations, privacy policy and Terms of Use for access or usage of domain name portal.
        vasundharaa.in ('Website'), including the related mobile site and mobile application (hereinafter
        referred to as 'Platform').
      </p>
      <p>
        The Platform is owned by Vasundharaa Geo Technologies Private Limited, a company
        incorporated under the Companies Act, 1956 with its registered office at Pune, India (hereinafter
      ...
      <h3>The use of Platform and/or availing of our Services is subject to the following Terms of Use:</h3>
      <ul>
        ...
        <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Pune and Maharashtra.</li>
        <li>All concerns or communications relating to these Terms must be directed to us as per the communication channels available on the Platform.</li>
      </ul>
    </div>
  );
};
