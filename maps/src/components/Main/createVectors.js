...
function CreateVectors() {
  ...
  const {map,customMarker,layerControls,getCsrfToken, CreationMode,
    SetCreationMode,
    EditMode,
    SetEditMode,Canvas}=useContext(GlobalContext)
 ...
 function HandleEdit(){
  ...
  return (
    <div style={{ position: show ? "absolute" : "relative" }} className="toolscont">
      <button
